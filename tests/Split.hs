...
-- This type allows us to run splitInteger and get a list of bits out.
...
-- Check that splitInteger gives a prefix-free code,
-- i.e., if m /= n then splitInteger m is not a prefix of splitInteger n.
